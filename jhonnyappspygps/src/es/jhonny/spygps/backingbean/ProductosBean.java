...
public class ProductosBean extends Navegacion implements Serializable{

	private static final long serialVersionUID = -250746753488753303L;
	...
	public void muestraMensajeLoginNecesario(ActionEvent event){
		...
		context.addMessage("formularioProductos:linkMapaNo", new FacesMessage(FacesMessage.SEVERITY_ERROR, MessageFactory.getMessage("login_necesario"), null));
	}
}
